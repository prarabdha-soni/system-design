...
export const questions: Question[] = [
  ...
  },
  {
    ...
    description: 'Build a global video streaming platform that serves millions of users with personalized content recommendations and adaptive bitrate streaming',
    difficulty: 'Expert',
    ...
    estimatedTime: '50-65 min',
    companies: ['Netflix', 'Amazon', 'Disney', 'HBO', 'YouTube', 'Twitch'],
    tags: ['Video Streaming', 'CDN', 'Recommendations', 'Adaptive Bitrate', 'Microservices'],
    interviewLevel: 'Senior',
  },
  {
    id: 11,
    title: 'Design Uber (Ride-Sharing Platform)',
    description: 'Design a real-time ride-sharing platform that matches drivers with riders, handles dynamic pricing, and provides real-time tracking and payments',
    difficulty: 'Expert',
    author: 'mobilityexpert',
    timeAgo: '6 hours ago',
    views: 987,
    solutions: 3,
    ...
    category: 'Real-time Systems',
    estimatedTime: '55-70 min',
    companies: ['Uber', 'Lyft', 'DoorDash', 'Instacart', 'Amazon'],
    tags: ['Real-time', 'Matching', 'Geolocation', 'Dynamic Pricing', 'Payments'],
    interviewLevel: 'Senior',
  },
  {
    id: 12,
    title: 'Design Twitter (Social Media Platform)',
    description: 'Build a social media platform that handles millions of tweets, real-time feeds, trending topics, and global user interactions with high availability',
    difficulty: 'Expert',
    author: 'socialexpert',
    timeAgo: '8 hours ago',
    views: 1345,
    ...
    category: 'Scalable Systems',
    estimatedTime: '60-75 min',
    companies: ['Twitter', 'Meta', 'LinkedIn', 'TikTok', 'Snapchat'],
    tags: ['Social Media', 'Real-time Feeds', 'Trending', 'Notifications', 'Scalability'],
    interviewLevel: 'Staff',
  },
  {
    id: 13,
